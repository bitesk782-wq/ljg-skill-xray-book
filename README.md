...
- **Windows:** Double-click the `.exe` file and follow the prompts on the screen.
- **macOS:** Open the `.dmg` file, drag the app icon to your Applications folder.
- **Linux:** Make the downloaded file executable (`chmod +x filename`), then run it.
...
## ⚙️ How to Use ljg-skill-xray-book
